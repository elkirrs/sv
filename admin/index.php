...
<?php header('Location: /sv/admin/comments.php'); ?>
<?php else : ?>
    <body>
    <div class="container p-5 text-center">
        <div class="row justify-content-center p-5">
            <form class="form-signin" action="../model/forms.php" method="post">
                ...
                <button class="btn btn-lg btn-primary btn-block" type="submit" name="singin">Войти</button>
